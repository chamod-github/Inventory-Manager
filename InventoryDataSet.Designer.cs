...
namespace The_Inventory_Manager {
    ...
    public partial class InventoryDataSet : global::System.Data.DataSet {
        ...
        public partial class inventoryDataTable : global::System.Data.TypedTableBase<inventoryRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public inventoryRow AddinventoryRow(string name, int quantity, decimal price, string description) {
...
namespace The_Inventory_Manager.InventoryDataSetTableAdapters {
    ...
    public partial class inventoryTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[inventory] WHERE (([Id] = @Original_Id) AND ([quantity] = @Ori" +
                "ginal_quantity) AND ([price] = @Original_price))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[inventory] ([name], [quantity], [price], [description]) VALUES" +
                " (@name, @quantity, @price, @description);\r\nSELECT Id, name, quantity, price, de" +
                "scription FROM inventory WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[inventory] SET [name] = @name, [quantity] = @quantity, [price] = @price, [description] = @description WHERE (([Id] = @Original_Id) AND ([quantity] = @Original_quantity) AND ([price] = @Original_price));
SELECT Id, name, quantity, price, description FROM inventory WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::The_Inventory_Manager.Properties.Settings.Default.inventory;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, name, quantity, price, description FROM dbo.inventory";
        ...
        public virtual int Update(string name, int quantity, decimal price, string description, int Original_Id, int Original_quantity, decimal Original_price, int Id) {
            if ((name == null)) {
                throw new global::System.ArgumentNullException("name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, int quantity, decimal price, string description, int Original_Id, int Original_quantity, decimal Original_price) {
            return this.Update(name, quantity, price, description, Original_Id, Original_quantity, Original_price, Original_Id);
        }
    }
